...
using CairoMakie, Random, PlutoUI
...
# ╔═╡ ce8608e5-caf6-4dd9-965b-179d8b747c7a
begin 
	f2 = Figure()
	...
	lines!(ax1, z, color = :black, label = "z")
	scatter!(ax1, z, color = :green)
	
	lines!(ax2, q, color = :blue, label = "q")
	scatter!(ax2, q, color = :tomato)
	#axislegend(ax, position=:rb)
	f2
end

# ╔═╡ 1941ad6d-24a6-43d9-9ed5-b20fb295f1e5
...
manifest_format = "2.0"
project_hash = "dbdf93cfc2b4d73b0955c183e4dfd83d18ea046c"
